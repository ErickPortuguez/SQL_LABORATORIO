...
/*ejemplo 1 : esto buscará todas las filas en la tabla table_name donde el valor de la columna column_name contenga una ocurrencia del patrón especificado en la expresión regular 'pattern'./*

SELECT column_name
FROM table_name
WHERE REGEXP_INSTR(column_name, 'pattern') > 0;

/*ejemplo 2:Esto reemplazará todas las ocurrencias del patrón especificado en la columna column_name con la cadena de reemplazo 'replacement' y mostrará el resultado como modified_value.*/

SELECT REGEXP_REPLACE(column_name, 'pattern', 'replacement') AS modified_value
FROM table_name;
/* ejemplo 3:Esto extraerá las subcadenas de la columna column_name que coincidan con el patrón especificado en la expresión regular 'pattern' y las mostrará como extracted_value./*

SELECT REGEXP_SUBSTR(column_name, 'pattern') AS extracted_value
FROM table_name;

/*ejemplo4:Esto buscará todas las filas en la tabla table_name donde el valor de la columna column_name coincida con el patrón especificado en la expresión regular 'pattern'.
...
/*ejemplo 1:Conceder el privilegio SELECT a un usuario en una tabla específica: Esto permite al usuario especificado (username) realizar operaciones de lectura (SELECT) en la tabla especificada (table_name).*/

GRANT SELECT ON table_name TO username;

/*ejemplo 2:Conceder los privilegios INSERT, UPDATE y DELETE a un usuario en una tabla: Esto permite al usuario especificado (username) realizar operaciones de inserción (INSERT), actualización (UPDATE) y eliminación (DELETE) en la tabla especificada (table_name)./*
...
/*ejemplo 7: Revocar el privilegio DELETE a un usuario en una tabla específica: Esto retira el privilegio de eliminación (DELETE) al usuario especificado (username) en la tabla especificada (table_name).*/
